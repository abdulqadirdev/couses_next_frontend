...
import { MapPin, Phone, User, FileCheck, CalendarDays, Flame } from "lucide-react"
import Image from "next/image"

// Institute type definition
interface Institute {
  _id: string
...
export default function InstitutePage({ params }: { params: { id: string } }) {
  ...
  // Mock institute data (in a real app, this would be fetched from an API)
  const institute: Institute = {
    _id: "67f996fdb41f823fb9511c26",
    instituteName: "SMIT",
    instituteAddress: "Lorem ipsum hel wrqwropsad sd sdos sopwkpw qqowmdm..",
    ownerCnic: "12345-6789014-3",
    phone: 12345678901,
    approvedByAdmin: true,
    instituteLogo: "https://res.cloudinary.com/dhvtjvx8y/image/upload/v1744659944/Logo-85%...",
    createdBy: "67f6a0349c9a014f93288bae",
  ...
  const onSubmit = async (data: Student) => {
    ...
    // Add institute ID to the form data
    const studentData = {
      ...data,
      institute: params.id,
    }
    ...
    <div className="min-h-screen w-full bg-gradient-to-b from-gray-900 via-gray-900 to-gray-800 px-4 py-16 sm:px-6 sm:py-20 lg:px-8">
      ...
      <div className="relative z-10 mx-auto max-w-7xl">
        ...
        <div className="mb-12 text-center">
          ...
          <p className="mx-auto max-w-2xl text-gray-300">View institute information and register as a student</p>
        </div>
        ...
        <div className="mb-10 overflow-hidden rounded-xl border border-gray-800 bg-gradient-to-br from-gray-900 via-gray-900 to-gray-800 shadow-xl shadow-purple-900/5 backdrop-blur-sm">
          ...
          <div className="border-b border-gray-800 bg-gray-900/80 px-6 py-4">
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-white">Institute Information</h2>
            </div>
          </div>
          ...
          <div className="p-6">
            <div className="flex flex-col items-center gap-6 md:flex-row md:items-start">
              ...
              <div className="flex-grow space-y-4">
                <div>
                  <h1 className="mb-1 text-2xl font-bold text-white">{institute.instituteName}</h1>
                  <div className="inline-flex items-center rounded-full bg-purple-900/50 px-3 py-1 text-xs font-medium text-purple-200">
                    {institute.approvedByAdmin ? "Verified Institute" : "Pending Verification"}
                  </div>
                </div>
                ...
                <div className="grid gap-4 md:grid-cols-2">
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-200">{institute.instituteAddress}</p>
                      </div>
                    </div>
                  ...
                  <div className="space-y-3">
                    <div className="flex items-start">
                      ...
                      <div>
                        <p className="text-sm font-medium text-gray-400">Owner CNIC</p>
                    ...
                    <div className="flex items-start">
                      ...
                      <div>
                        ...
                        <p className="text-gray-200">{new Date(institute.createdAt).toLocaleDateString()}</p>
                      </div>
                    </div>
                  </div>
                </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
              <div className="grid gap-6 md:grid-cols-2">
                <div className="group relative">
                  <label htmlFor="studentName" className="mb-2 block text-sm font-medium text-gray-300">
                    Full Name
                  </label>
                  <div className="relative transition-all duration-300 group-hover:scale-[1.01]">
                    <input
                      ...
                      className={`w-full rounded-md border ${
                        errors.studentName ? "border-red-500" : "border-gray-700"
                ...
                <div className="group relative">
                  <label htmlFor="studentCnic" className="mb-2 block text-sm font-medium text-gray-300">
                    CNIC Number
                  </label>
                  <div className="relative transition-all duration-300 group-hover:scale-[1.01]">
                    <input
                      ...
                      type="text"
                      className={`w-full rounded-md border ${
                        errors.studentCnic ? "border-red-500" : "border-gray-700"
                      } bg-gray-800 px-4 py-3 text-white shadow-sm transition-all duration-300 placeholder:text-gray-500 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500 group-hover:border-purple-400 group-hover:shadow-md group-hover:shadow-purple-900/20`}
                  ...
                  {errors.studentCnic && <p className="mt-1 text-xs text-red-400">{errors.studentCnic.message}</p>}
                </div>
                ...
                <div className="group relative md:col-span-2">
                  <label htmlFor="studentAddress" className="mb-2 block text-sm font-medium text-gray-300">
                    Address
                  </label>
                  <div className="relative transition-all duration-300 group-hover:scale-[1.01]">
                    <input
                      ...
                      type="text"
                      className={`w-full rounded-md border ${
                        errors.studentAddress ? "border-red-500" : "border-gray-700"
                      } bg-gray-800 px-4 py-3 text-white shadow-sm transition-all duration-300 placeholder:text-gray-500 focus:border-purple-500 focus:outline-none focus:ring-2 focus:ring-purple-500 group-hover:border-purple-400 group-hover:shadow-md group-hover:shadow-purple-900/20`}
                  ...
                  {errors.studentAddress && (
                    <p className="mt-1 text-xs text-red-400">{errors.studentAddress.message}</p>
                  )}
                </div>
              </div>
